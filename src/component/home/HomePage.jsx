...
import DeskSearch from "../common/DeskSearch";
...
const HomePage = () => {
  ...
  return (
    <div className="home">
      ...
      <section>
        <header className="header-banner">
          ...
          <div className="animated-texts overlay-content">
            <h1>
              Welcome to <span className="phegon-color">Mona's Restaurant</span>
            </h1>
            <br />
      ...
      {/* SEARCH/FIND AVAILABLE DESK SECTION */}
      <DeskSearch handleSearchResult={handleSearchResult}/>
      <h4>
        <a className="view-rooms-home" href="/desks">
          All Desks
        </a>
      </h4>

      <h2 className="home-services">
        Services at <span className="phegon-color">Mona's Restaurant</span>
      </h2>
